...
$app->get('/user/signup/activate/{nonce}', 'App\Controller\UserController:account_activate')
...
$app->post('/data/get/real/airquality', 'App\Controller\DataController:select_realtime_data_from_airquality_table')
    ->setName('getrealairquality'); // get real time data and draw map 
...
->setName('gethistoricalairquality'); // airquality data for chart
...
->setName('markerthistoricalairquality'); // airquality data is  for map
...
->setName('apphistoricalairquality');   //airquality for app
...
$app->post('/data/get/historical/heartrate', 'App\Controller\DataController:select_historical_heartrate_data_from_heartrate_table')
    ->setName('gethistoricalairquality');  //heart data for chart

$app->post('/data/get/historical/heartrate/marker', 'App\Controller\DataController:marker_select_historical_heartrate_data_from_heartrate_table')
    ->setName('markerhistoricalairquality');  //heart data for map

$app->post('/app/get/historical/heartrate', 'App\Controller\DataController:app_select_historical_heartrate_data_from_heartrate_table')
    ->setName('apphistoricalairquality');  //heart data for chart
